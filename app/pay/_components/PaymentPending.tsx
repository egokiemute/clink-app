  ...
  return (
    <div className="space-y-6 bg-white!">
      <div className="text-center">
        <p className="text-xs uppercase tracking-[0.18em] text-primary/40">
      ...
      <div className="rounded-xl border border-amber-200 bg-amber-50 px-4 py-3">
        <p className="text-xs text-amber-800">
          <span className="font-medium">Important:</span> Include the memo
          exactly as shown — without it your payment cannot be matched.
        </p>
      </div>
