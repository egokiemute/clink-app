  ...
  return (
    <>
      <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
        <div
          className="absolute left-1/2 -top-40 h-128 w-lg -translate-x-1/2 rounded-full blur-3xl"
          style={{
            background:
        ...
        />
        <div
          className="absolute top-1/2 right-7.5 h-120 w-120 -translate-y-1/2 rounded-full blur-3xl"
          style={{
            background:
              "linear-gradient(180deg, rgba(50, 195, 164, 0.5) 0%, rgba(161, 255, 124, 0.5) 100%)",
          }}
        />
        <div className="absolute inset-8 rounded-full bg-secondary/60 blur-3xl" />
      </div>
      <main className="relative z-10 mx-auto flex min-h-screen w-full max-w-7xl flex-col px-6 py-6 lg:px-10 lg:py-8">
        ...
        <section className="-mt-18 md:mt-0 grid flex-1 items-center gap-12 pb-10 lg:grid-cols-[1.1fr_0.9fr] z-50">
          <div className="max-w-2xl">
            ...
            <p className="mt-6 max-w-xl text-md md:text-lg leading-7 tracking-[-1%] text-primary sm:text-xl">
              Integrate a drop-in crypto checkout in minutes. Let your users pay
              with USDC directly from wallets or exchanges while Clink manages
              addresses, networks, and real-time confirmations.
            </p>
